...
# Version
default['apache']['version'] = "httpd-2.2.26"

# Directory
default['apache']['dir']     = "/usr/local/apache2/"
default['apache']['dir_install']     = "/usr/local/apache2"
...
# Configure Options
default['apache']['configure']  = "--prefix=#{default['apache']['dir_install']} --enable-ssl --with-ssl --enable-rewrite=shared --enable-headers=shared --enable-so --with-mpm=prefork"
...
default['apache']['directory_index'] = "index.html"
